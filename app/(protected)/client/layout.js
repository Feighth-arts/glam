...
export const metadata = {
  ...
  description: "Client Dashboard to manage their services and bookings",
};

export default function ProviderLayout({ children }) {
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} ${greatVibes.variable} ${roboto.variable} ${sakitu.variable} antialiased bg-light-gray h-screen overflow-hidden`}>
      {/* Desktop Layout */}
