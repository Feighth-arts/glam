// EmailJS is client-side only - will be dynamically imported when needed
let emailjs = null;
...
export const sendEmail = async (emailData) => {
  ...
  try {
    if (!emailjs) {
      console.log('EmailJS not available on server - Email would be sent:', emailData);
      return { success: true, message: 'Email skipped (server-side)' };
    }
