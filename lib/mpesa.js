...
async function getAccessToken() {
  ...
  try {
    ...
    throw new Error('Failed to get access token: Invalid API response');
  }
}
...
export async function initiateSTKPush(phoneNumber, amount, accountReference, transactionDesc) {
  try {
    ...
    try {
      ...
      throw new Error('Failed to initiate STK push: Invalid API response');
    }
  } catch (error) {
...
export async function querySTKStatus(checkoutRequestID) {
  try {
    ...
    try {
      ...
      throw new Error('Failed to query STK status: Invalid API response');
    }
  } catch (error) {
